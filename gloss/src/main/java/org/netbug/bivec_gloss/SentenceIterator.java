 ...
 * @author Alex Black
 */
public class SentenceIterator implements DataSetIterator {
    /**
	 * 
	 */
	private static final long serialVersionUID = -5504248813783069718L;
     ...
     */
    public SentenceIterator(String dataDirectory, WordVectors wordVectors, int batchSize, int truncateLength, boolean train) throws IOException {
        ...
        System.out.println("Sentence iterator loaded " + totalExamples() + " reviews!");
    }
    ...
    private DataSet nextDataSet(int num) throws IOException {
        ...
        //System.out.println("Fetching data from SentenceIterator!");
